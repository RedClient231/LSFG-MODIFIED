...
int create_session(VulkanSession &out) {
    ...
    // Mali GPUs identify as ARM (vendorID 0x13B5). MediaTek SoCs pair these
    // with vendor-tuned firmware whose AHB tile/format reporting drifts from
    // the Adreno reference path the upstream LSFG-Android targets. We gate
