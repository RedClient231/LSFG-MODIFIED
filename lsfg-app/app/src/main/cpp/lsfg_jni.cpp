...
extern "C" JNIEXPORT jstring JNICALL
Java_com_lsfg_android_session_NativeBridge_getProbeRejectReason(
        JNIEnv *env, jclass /*cls*/) {
    // Companion to probeShaders. When probeShaders returned -12 (driver
    // rejected one of the cached SPIR-V blobs) this returns a human-readable
    // explanation for the UI; otherwise returns "".
    const std::string r = lsfg_android::get_last_probe_reject_reason();
